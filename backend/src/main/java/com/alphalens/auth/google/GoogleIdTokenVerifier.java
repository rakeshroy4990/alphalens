package com.alphalens.auth.google;
...
public class GoogleIdTokenVerifier {
    ...
    public Optional<VerifiedGoogleProfile> verify(String rawIdToken) {
        ...
        try {
            ...
            return Optional.of(new VerifiedGoogleProfile(email, stringClaim(claims, "given_name"), stringClaim(claims, "family_name")));
    ...
    public record VerifiedGoogleProfile(String email, String givenName, String familyName) {
    }
}
